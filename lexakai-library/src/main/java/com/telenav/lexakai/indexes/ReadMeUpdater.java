 ...
 *
 * <p>
 * The project is passed to the constructor. The {@link #update()} method updates the read me file. The
 * {@link LexakaiProject#javadocSectionPattern()} setting determines how Javadoc sections are located. The
 * {@link LexakaiProject#childProjects()} setting provides a list of projects to index for projects with *pom* packaging
